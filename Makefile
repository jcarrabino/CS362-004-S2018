...
clean:
	rm -f *.o playdom.exe playdom player player.exe cardtest1.exe cardtest2.exe cardtest3.exe cardtest4.exe unittest1.exe unittest2.exe unittest3.exe unittest4.exe *.gcov *.gcda *.gcno *.so *.out testDrawCard testDrawCard.exe badTestDrawCard cardtest1 cardtest2 cardtest3 cardtest4 unittest1 unittest2 unittest3 unittest4
